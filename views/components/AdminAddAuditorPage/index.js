...
@reduxForm({
  ...
  onSubmit: (data) => addAdmin({ ...data, level: 2 })
})
class AdminAddAuditorForm extends React.Component {
  render() {
...
export default AdminAddAuditorPage;
