...
import { loadOrders } from '../../redux/modules/shopping';
    ...
    const columns = [
      {
        ...
        render: (d) => {
          switch (d.status) {
            case 0:
              return <Button type="ghost" onClick={pay}>确认付款</Button>
            case 1:
            ...
            case 2:
              return <Button type="ghost"  onClick={toggleReviewModal}>确认收货</Button>
            case 3:
              if (userId == d.buyerId)
                return <Button type="ghost"  onClick={toggleRefundModal}>退货申请</Button>
            case 4:
              if (userId == d.sellerId)
    ...
    return (
      <div>
        ...
        <div className={styles.table}>
          // <Table className={styles.shoppingOrderTable} columns={columns} dataSource={this.props.orders} pagination={pagination} />
        </div>
        // <div>
        //   <ShoppingReviewModal />
        //   <ShoppingRefundModal />
